...
#first use pearson
pearson_cor<-cor(tooth_length, dose, method="pearson")
print(pearson_cor)
...
correlation_results <- ("The pearson correlation between the tooth growth and dosage is 0.8026913, indicating a positive correlation.
...
one_sample.ks.test_results <- ("The one sample ks test shows a p-value of 0.6237, which is greater than 0.05 so the null hypothesis is not rejected and represents a goodness of fit to the normal distribution and therefore can be assumed that the data distribution is normal")

#comparing results of parametric and nonparametric tests
Q5_analysis <- ("")
#TO BE CONTINUED
#
#
